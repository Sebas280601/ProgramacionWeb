...
<header>
    ...
    <div id="titulo">
        ...
        <h2 id="t2" name="tituloRaza" ><?php echo $Raza; ?></h2>
    ...
    <main>
        ...
        <div id="img">
            ...
            <div id="scroll">
                ...
                <img id="img1" src="<?php echo $Imagen; ?>">
                <img id="img2" src="img/imagenIcon.png">
            </div>
        </div>

        <div id="cat">
            <h1 id="t4" name="tituloRaza"><?php echo $Raza; ?></h1>
            <h2 id="t5" name="infoRaza"><?php echo $Texto; ?></h2>
            <p><?php echo $Texto; ?></p>
